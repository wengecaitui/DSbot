...
export const workbenchQueryKeys = {
  ...
  binanceRead: () => [...workbenchQueryKeys.root, 'binance-read'] as const,
...
export const workbenchQueries = {
  ...
  binanceRead: () => queryOptions({ queryKey: workbenchQueryKeys.binanceRead(), queryFn: workbenchApi.binanceRead, ...stable, retry: false }),
